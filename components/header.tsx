...
import { Protect, SignInButton, UserButton, useAuth, useUser } from "@clerk/nextjs";
...
const ADMIN_EMAIL = "apsingh.6423@gmail.com";
              ...
              <>
                ...
                {!showDashboardNav && (
                  <Link href="/dashboard/projects">
                    <Button variant="ghost" size="sm" className={isDashboard ? "hover-scale text-white hover:bg-white/20 transition-all duration-300" : "hover-scale transition-all duration-300"}>
                ...
                {showDashboardNav && (
                  <Link href="/" className="hidden lg:block">
                    <Button variant="ghost" size="sm" className={isDashboard ? "gap-2 hover-scale text-white hover:bg-white/20 transition-all duration-300" : "gap-2 hover-scale transition-all duration-300"}>
